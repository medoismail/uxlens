...
export function Hero({ onSubmit, isLoading }: HeroProps) {
  return (
    <section className="relative overflow-hidden">
      {/* Interactive ASCII background — sits behind everything */}
      <HeroBackground />

      {/* Content — all above the canvas */}
      <div className="relative z-[1] flex flex-col items-center text-center px-6 pt-16 pb-16">
        {/* Badge */}
