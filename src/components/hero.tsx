  ...
  return (
    <section className="relative flex flex-col items-center text-center px-6 pb-24 -mt-14" style={{ paddingTop: "calc(56px + 48px)" }}>
      ...
      <motion.p
        ...
        className="mt-5 text-[15px] leading-relaxed text-foreground/60 max-w-[520px] relative z-[1]"
      >
      ...
      <motion.div
        ...
        className="mt-10 w-full max-w-lg relative z-[1]"
      >
      ...
      >
        {FEATURES.map((feat) => (
          <motion.span
            ...
            className="inline-flex items-center gap-1.5 text-[11px] font-medium text-foreground/45 tracking-wide px-2.5 py-1 rounded-full border cursor-default select-none transition-colors hover:text-foreground/65 hover:border-foreground/15"
