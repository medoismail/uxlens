  ...
  return (
    <div className="flex flex-col items-center py-16 px-6 animate-fade-in relative z-[1]">
      ...
      <div className="w-full max-w-3xl mt-10">
        <p className="text-[10px] font-mono uppercase tracking-[2px] text-foreground/30 text-center mb-5">
          Choose a plan
        </p>
      ...
      {/* OR divider */}
      <div className="flex items-center gap-4 my-10 w-full max-w-lg text-foreground/20 text-[10px] uppercase tracking-[2px]">
      ...
      <div className="w-full max-w-lg rounded-xl border p-6" style={{ background: "var(--s1)", borderColor: "var(--border2)" }}>
        ...
        <form onSubmit={handleRequestHumanAudit} className="space-y-2.5">
          ...
          {auditError && <p className="text-[11px] text-destructive animate-fade-in pl-1">{auditError}</p>}
          <button
            type="submit"
      ...
      <div className="mt-8 text-center">
        <p className="text-[11px] text-foreground/30 mb-2.5">Already subscribed?</p>
