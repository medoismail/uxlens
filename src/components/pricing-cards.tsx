        ...
        >
          {plan.popular && (
            <div className="absolute -top-2.5 left-1/2 -translate-x-1/2">
              <span className="inline-flex items-center rounded-full bg-foreground px-2.5 py-0.5 text-[16px] font-medium text-background uppercase tracking-wider">
                Popular
              </span>
            </div>
          )}
          ...
          <div className="mt-2 flex items-baseline gap-0.5">
            ...
            <span className="text-[16px] text-muted-foreground/60">{plan.period}</span>
          </div>
          <p className="text-[16px] text-muted-foreground/60 mt-1">{plan.audits}</p>
          ...
          <button
            ...
            className={`w-full mt-5 rounded-lg py-2 text-[16px] font-medium transition-all duration-150 active:scale-[0.98] ${
              plan.popular
