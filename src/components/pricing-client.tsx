    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main id="main-content" className="flex-1 mx-auto w-full max-w-[960px] px-6 relative z-[1]">
        ...
        <div className="flex flex-col items-center text-center pt-16 pb-12">
          ...
          <p className="mt-3 text-[16px] text-foreground/40 max-w-md leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 w-full">
          ...
          <div className="relative rounded-xl border p-5 border-border/40 bg-card/50 hover:border-border/60 transition-all duration-200">
            <p className="text-[16px] font-semibold text-foreground">Free</p>
            <div className="mt-2 flex items-baseline gap-0.5">
              <span className="text-2xl font-bold tracking-tight text-foreground">$0</span>
              <span className="text-[16px] text-muted-foreground/60">/mo</span>
            </div>
            <p className="text-[16px] text-muted-foreground/60 mt-1">5 audits/month</p>

            <ul className="mt-4 space-y-2">
              {["Overall UX score & grade", "6 category breakdowns", "Top 3 conversion killers", "2 quick wins", "Confusion metric scores"].map((f) => (
                <li key={f} className="flex items-start gap-2 text-[16px] text-muted-foreground">
            ...
            <Link
              href="/"
              className="flex items-center justify-center w-full mt-5 rounded-lg py-2 text-[16px] font-medium border border-border/50 bg-background text-foreground hover:border-border hover:shadow-elevation-1 transition-all duration-150 active:scale-[0.98]"
            >
              Get Started Free
            </Link>
          </div>
        ...
        {/* Divider */}
        <div className="flex items-center gap-4 my-12 text-foreground/15 text-[16px] uppercase tracking-[2px]">
        ...
        <div className="max-w-xl mx-auto rounded-xl border p-6" style={{ background: "var(--s1)", borderColor: "var(--border2)" }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h2 className="text-[16px] font-semibold tracking-tight">Get a Human Audit</h2>
          ...
          <p className="text-[16px] text-foreground/40 leading-relaxed mb-4">
          ...
          <button
            ...
            className="inline-flex w-full h-10 items-center justify-center gap-2 rounded-lg px-5 text-[16px] font-bold transition-all duration-150 hover:opacity-90 active:scale-[0.98]"
        ...
        <div className="mt-10 mb-16 text-center">
          <p className="text-[16px] text-foreground/30 mb-3">Already subscribed?</p>
          ...
          {verifySuccess && (
            <p className="mt-2 text-[16px] animate-fade-in" style={{ color: "var(--score-high)" }}>
