    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://app.lemonsqueezy.com https://*.clerk.accounts.dev https://*.clerk.com",
              ...
              "frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://app.lemonsqueezy.com",
